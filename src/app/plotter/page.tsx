...
  // Handler for 2D Implicit Plot (แก้ไขแล้ว)
  const handlePlotImplicit = async () => {
    setIsLoading(true);
    setError("");
    try {
      const apiUrl = process.env.NEXT_PUBLIC_API_URL || "https://java-engine-1.onrender.com"; // <-- เพิ่ม
...
  // Handler for Complex Plot (แก้ไขแล้ว)
...
      });
      // แก้ไข URL
      const url = `${apiUrl}/plotter/complex?${params.toString()}`;
